                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="fromKamarkita" method="post" action="<?=base_url('kamar') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kamarstatus_id" class="form-control">
                            </div>
                            <div class="mb-3">
...
<script>
    $(document).ready(function(){
        ...
        $('button#btn-tambah').on('click' , function(){
            ...
            $('form#fromKamarkita').trigger('reset');
