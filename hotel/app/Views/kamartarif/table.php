                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formkamartariff" method="post" action="<?=base_url('kamartarif') ?>">
...
<script>
    $(document).ready(function(){
        ...
        $('form#formTiprtariff').submitAjax({
        pre:()=>{
        ...
        $('button#btn-tambah').on('click' , function(){
            ...
            $('form#formkamartariff').trigger('reset');
