        ...
        <script src="https://cdn.jsdelivr.net/gh/agoenxz2186/submitAjax@develop/submit_ajax.js"
            ...
            <div class="container">
                ...
                <table id='table-pembayarankita' class="datatable table table-bordered">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Tanggal</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formPembayaranKamu" method="post" action="<?=base_url('pembayaran') ?>">
...
<script>
    $(document).ready(function(){
        ...
        $('form#formPembayaranKamu').submitAjax({
        pre:()=>{
        ...
        success:(response, status)=>{
            ...
            $("table#table-pembayarankita").DataTable().ajax.reload();
        },
        ...
        $('button#btn-menambahkan').on('click' , function(){
            $('form#formPembayaranKamu').submit();
        ...
        $('button#btn-tambah').on('click' , function(){
            ...
            $('form#formPembayaranKamu').trigger('reset');
            $('input[name=_method]').val('');
        });

        $('table#table-pembayarankita').on('click', '.btn-light', function (){
            let id = $(this).data('id');
            ...
            $.get(`${baseurl}/pembayaran/${id}`).done((e)=>{
                ...
                $('input[name=nama_pembayar]').val(e.tagihan);
        ...
        $('table#table-pembayarankita').on('click', '.btn-danger', function (){
        ...
        $('table#table-pembayarankita').DataTable({
            processing: true,
            serverSide: true,
            ajax:{
