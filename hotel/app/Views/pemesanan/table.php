                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formPemesananKita" method="post" action="<?=base_url('pemesanan') ?>">
...
<script>
    $(document).ready(function(){
        ...
        $('form#formPemesananKita').submitAjax({
        pre:()=>{
        ...
        $('button#btn-tambah').on('click' , function(){
            ...
            $('form#formPemesananKita').trigger('reset');
