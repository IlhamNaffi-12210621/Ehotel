<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css"
        ...
        <script src="https://cdn.jsdelivr.net/gh/agoenxz2186/submitAjax@develop/submit_ajax.js"
            ...
            <div class="container">
                ...
                <table id='table-tamukami' class="datatable table table-bordered">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Depan</th>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formTamukita" method="post" action="<?=base_url('tamu') ?>">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Negara ID</label>
                                <input type="text" name="negara_id" class="form-control">
                            </div>
                            <div class="mb-3">
...
<script>
    $(document).ready(function(){
        ...
        success:(response, status)=>{
            ...
            $("table#table-tamukami").DataTable().ajax.reload();
        },
        ...
        $('button#btn-tambah').on('click' , function(){
            ...
            $('form#formTamukita').trigger('reset');
            $('input[name=_method]').val('');
        });

        $('table#table-tamukami').on('click', '.btn-light', function (){
            let id = $(this).data('id');
        ...
        $('table#table-tamukami').on('click', '.btn-danger', function (){
        ...
        $('table#table-tamukami').DataTable({
            processing: true,
            serverSide: true,
            ajax:{
